    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h2 class="text-2xl font-bold mb-4">Nouveau Produit</h2>
                ...
                <form action="{{ route('produits.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nom_prod" value="{{ old('nom_prod') }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Balance initiale</label>
                        <input type="number" name="balance" value="{{ old('balance', '0.00') }}" step="0.01"
