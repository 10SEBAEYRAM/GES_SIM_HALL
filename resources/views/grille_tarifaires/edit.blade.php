                ...
                <form action="{{ route('grille-tarifaires.update', $grilleTarifaire->id_grille_tarifaire) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="montant_min"
                            value="{{ old('montant_min', $grilleTarifaire->montant_min) }}" step="1" min="0"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="montant_max"
                            value="{{ old('montant_max', $grilleTarifaire->montant_max) }}" step="1" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="commission_grille_tarifaire"
                            ...
                            step="1" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            required>
                    </div>
